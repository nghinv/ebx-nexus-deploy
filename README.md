...
```
$ export ebxVersionNumber=5.8.0.1054-0021
$ cd ../docker-ebx-dataonly/
$ docker build --build-arg EBXFILE=ebx_CD_5.8.0.1054-0021.zip -t ebx-dataonly:$ebxVersionNumber .
$ docker login
...
$ docker build --build-arg EBX_FILE=ebx_$ebxAddonsVersionNumber.zip -t ebx-addons-dataonly:$ebxAddonsVersionNumber .
